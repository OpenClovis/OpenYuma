...
# this dummy devel package is not used here
# it is built with the yuma2all.spec rules instead
# the H files are installed on Fedora and this is an easier fix
# than adding more ifdefs to the Makefiles
%package devel
BuildArch: noarch
